...
import uk.autores.processing.test.testing.env.TestElement;
...
class JavaWriterTest {
    ...
    void canGenerateClass() throws IOException {
        ...
        // verify
        String expected = "// GENERATED CODE: uk.autores.processing.test.handlers.JavaWriterTest" + NL;
    ...
    private JW instance(Object generator, Context ctxt, Writer writer, String className, String comment) {
        return Proxies.instance(JW.class, "uk.autores.processing.handlers.JavaWriter")
                .params(Object.class,
                        Context.class,
                        Writer.class,
                        String.class,
