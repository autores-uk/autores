...
public class PrintResources {
    ...
    public static void main(String...args) throws IOException {
        ...
        String absolute = load(PrintResources.class::getResourceAsStream, "/" + ABSOLUTE);
        System.out.println(absolute);
    }

    private static String load(ResourceAsStream ras, String resource) throws IOException {
